...
ConstJoint link1_c = JointTable[EEPROM.read(link1Addr)];
ConstJoint link2_c = JointTable[EEPROM.read(link2Addr)];
ConstJoint link3_c = JointTable[EEPROM.read(link3Addr)];
ConstJoint* link1_cp;
ConstJoint* link2_cp;
ConstJoint* link3_cp;
